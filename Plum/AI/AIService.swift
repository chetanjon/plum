...
struct AIService {
    static let systemPrompt =
        "You are Plum, a tiny assistant living in the Mac notch. Answer in as few words as possible. Plain text only, no markdown."
    ...
    static func translateToVerb(_ utterance: String) async -> String? {
        let prompt = """
        Translate the request into exactly one Plum command from this list, \
