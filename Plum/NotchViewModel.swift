...
final class NotchViewModel: ObservableObject {
    ...
    private let onboardedKey = "plum.onboarded"
    ...
    /// Default pill for notch-less displays, so Plum works on any Mac.
    ...
    func start() {
        ...
        //   Notification name com.cj.plum.debug.submit, text in object.
        DistributedNotificationCenter.default().addObserver(
            forName: Notification.Name("com.cj.plum.debug.submit"),
            object: nil,
            queue: .main
        ) { [weak self] note in
            ...
            Task { @MainActor in
                ...
                // `defaults read com.cj.plum musicDebug`: the one
                ...
                // without opening it; read com.cj.plum joinDebug.
                if text == "debug join" {
                ...
                // "debug rec" records the live tap to /tmp/plum-tap.caf;
    ...
    /// `defaults read com.cj.plum voiceLog` from a terminal.
